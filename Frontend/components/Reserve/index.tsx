                      ...
                      <div className="w-full px-4 md:w-1/2">
                        <div className="mb-8">
                          ...
                          <TimePicker
                            ...
                            disableClock={true}
                            name='"hora"'
                            className="w-1/2 rounded-md border-transparent py-3 px-6 text-base text-black dark:text-yellow body-color/[60%] shadow-one outline-none focus:border-primary focus-visible:shadow-none dark:bg-[#0D263B] dark:shadow-signUp bg-[#fff]"
                          />
                        </div>
                      </div>
                      <div className="w-full px-4 md:w-1/2">
