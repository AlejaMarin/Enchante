                  ...
                  <div className="mx-auto max-w-[500px] rounded-md bg-primary/[20%] bg-opacity-5 px-6 py-10 dark:bg-primary/[20%] sm:p-[60px]">
                    ...
                    <div className="text-center">
                      ...
                      <button
                        ...
                        className={`mt-4 ease-in-up font-bold text-primary text-sm rounded-md mr-2 p-2 text-md ${selectedOption === 1 ? 'bg-dark' : 'bg-white'}`}
                      >
                        Opción 1
                      </button>
                      <button
                        onClick={() => handleOptionChange(2)}
                        className={`ease-in-up font-bold text-sm text-primary rounded-md mr-2 p-2 text-md ${selectedOption === 2 ? 'bg-dark' : 'bg-white'}`}
                      >
                        Opción 2
                      </button>
                    </div>
