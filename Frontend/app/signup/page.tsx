...
const validationSchema = Yup.object({
  ...
  .matches(/^[a-zA-Z\s]+$/, "El nombre no puede tener números o caracteres especiales"),
lastName: Yup.string().required("Campo requerido")
  .max(20, "El apellido no puede tener más de 20 caracteres")
  .matches(/^[a-zA-Z\s]+$/, "El apellido no puede tener números o caracteres especiales"),
userName: Yup.string().required("Campo requerido")
  .max(20, "El usuario no puede tener más de 20 caracteres")
  .matches(/^\S*$/, "El usuario no puede contener espacios en blanco"),
email: Yup.string()
  .email("Correo electrónico inválido")
  .required("Campo requerido"),
password: Yup.string()
  .min(6, "La contraseña debe tener al menos 6 caracteres")
  .max(20, "Tu contraseña no puede tener más de 12 caracteres")
